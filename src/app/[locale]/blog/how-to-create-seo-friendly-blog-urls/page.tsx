...
const slug = "how-to-create-seo-friendly-blog-urls";
...
export default async function HowToCreateSeoFriendlyBlogUrls({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/url-slug-generator" className="text-blue-600 hover:underline">URL Slug Generator</Link> — Create SEO-friendly blog URL slugs</li>
              <li><Link href="/permalink-generator" className="text-blue-600 hover:underline">Permalink Generator</Link> — Generate clean permanent blog URLs</li>
              <li><Link href="/wordpress-slug-generator" className="text-blue-600 hover:underline">WordPress Slug Generator</Link> — Generate blog slugs for WordPress</li>
            </ul>
          </nav>
        </article>
      </main>

...
const slug = "css-naming-conventions-bem";
...
export default async function CssNamingConventions({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/kebab-case-converter" className="text-blue-600 hover:underline">Kebab Case Converter</Link> — Convert text to kebab-case (CSS/BEM convention)</li>

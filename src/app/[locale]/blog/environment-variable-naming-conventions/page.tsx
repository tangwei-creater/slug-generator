...
const slug = "environment-variable-naming-conventions";
...
export default async function EnvironmentVariableNamingConventions({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/constant-case-converter" className="text-blue-600 hover:underline">CONSTANT_CASE Converter</Link> — Convert text to SCREAMING_SNAKE_CASE (env var convention)</li>

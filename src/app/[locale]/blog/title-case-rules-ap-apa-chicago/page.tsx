...
const slug = "title-case-rules-ap-apa-chicago";
...
export default async function TitleCaseRules({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              ...
              <li><Link href="/sentence-case-converter" className="text-blue-600 hover:underline">Sentence Case Converter</Link> — Convert text to sentence case</li>

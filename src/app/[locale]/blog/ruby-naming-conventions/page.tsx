...
const slug = "ruby-naming-conventions";
...
export default async function RubyNamingConventions({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/snake-case-converter" className="text-blue-600 hover:underline">Snake Case Converter</Link> — Convert text to snake_case (Ruby convention)</li>
              <li><Link href="/pascal-case-converter" className="text-blue-600 hover:underline">PascalCase Converter</Link> — Convert text to PascalCase (Ruby classes)</li>
              <li><Link href="/constant-case-converter" className="text-blue-600 hover:underline">CONSTANT_CASE Converter</Link> — Convert text to SCREAMING_SNAKE_CASE (Ruby constants)</li>
            </ul>
          </nav>
        </article>
      </main>

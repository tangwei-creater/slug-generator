...
const slug = "file-naming-conventions";
...
export default async function FileNamingConventions({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/kebab-case-converter" className="text-blue-600 hover:underline">Kebab Case Converter</Link> — Convert text to kebab-case (file naming format)</li>
              ...
              <li><Link href="/slugify-online" className="text-blue-600 hover:underline">Slugify Online</Link> — Generate clean file-safe names</li>
            </ul>
          </nav>
        </article>
      </main>

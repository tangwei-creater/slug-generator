...
const slug = "sort-text-lines-online";
...
export default async function SortTextLinesOnline({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/sort-lines-alphabetically" className="text-blue-600 hover:underline">Sort Lines Alphabetically</Link> — Sort text lines A-Z or Z-A</li>

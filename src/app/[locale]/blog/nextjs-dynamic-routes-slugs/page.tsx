...
const slug = "nextjs-dynamic-routes-slugs";
...
export default async function NextjsDynamicRoutesSlugs({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/url-slug-generator" className="text-blue-600 hover:underline">URL Slug Generator</Link> — Create dynamic route slugs</li>
              <li><Link href="/slugify-online" className="text-blue-600 hover:underline">Slugify Online</Link> — Slugify text for Next.js routes</li>
              <li><Link href="/kebab-case-converter" className="text-blue-600 hover:underline">Kebab Case Converter</Link> — Convert text to kebab-case for URLs</li>
            </ul>
          </nav>
        </article>
      </main>

...
const slug = "plain-text-vs-rich-text";
...
export default async function PlainTextVsRichText({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/plain-text-converter" className="text-blue-600 hover:underline">Plain Text Converter</Link> — Strip formatting and convert to plain text</li>

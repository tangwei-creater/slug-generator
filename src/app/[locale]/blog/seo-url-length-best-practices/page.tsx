...
const slug = "seo-url-length-best-practices";
...
export default async function SeoUrlLengthBestPractices({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              ...
              <li><Link href="/slugify-online" className="text-blue-600 hover:underline">Slugify Online</Link> — Slugify text for clean URLs</li>
            </ul>
          </nav>
        </article>
      </main>

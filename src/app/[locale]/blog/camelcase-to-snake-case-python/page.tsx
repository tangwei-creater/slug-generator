...
const slug = "camelcase-to-snake-case-python";
...
export default async function CamelcaseToSnakeCasePython({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              ...
              <li><Link href="/snake-case-converter" className="text-blue-600 hover:underline">Snake Case Converter</Link> — Convert text to snake_case (Python convention)</li>

...
const slug = "how-to-remove-duplicate-lines";
...
export default async function HowToRemoveDuplicateLines({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/duplicate-line-remover" className="text-blue-600 hover:underline">Duplicate Line Remover</Link> — Remove duplicate lines from text</li>
              <li><Link href="/sort-lines-alphabetically" className="text-blue-600 hover:underline">Sort Lines Alphabetically</Link> — Sort and deduplicate text lines</li>
              <li><Link href="/remove-empty-lines" className="text-blue-600 hover:underline">Remove Empty Lines</Link> — Clean up blank lines from text</li>
            </ul>
          </nav>
        </article>
      </main>

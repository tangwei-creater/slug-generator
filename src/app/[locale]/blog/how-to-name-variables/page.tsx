...
const slug = "how-to-name-variables";
...
export default async function HowToNameVariables({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/camelcase-converter" className="text-blue-600 hover:underline">CamelCase Converter</Link> — Convert text to camelCase for variables</li>
              <li><Link href="/snake-case-converter" className="text-blue-600 hover:underline">Snake Case Converter</Link> — Convert text to snake_case for variables</li>
              <li><Link href="/case-converter-online" className="text-blue-600 hover:underline">Case Converter Online</Link> — Convert between any naming conventions</li>
            </ul>
          </nav>
        </article>
      </main>

...
const slug = "blog-post-url-structure-tips";
...
export default async function BlogPostUrlStructureTips({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/url-slug-generator" className="text-blue-600 hover:underline">URL Slug Generator</Link> — Create SEO-friendly blog post slugs</li>
              ...
              <li><Link href="/wordpress-slug-generator" className="text-blue-600 hover:underline">WordPress Slug Generator</Link> — Generate WordPress-compatible slugs</li>
            </ul>
          </nav>
        </article>
      </main>

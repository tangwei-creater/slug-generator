...
const slug = "how-search-engines-crawl-urls";
...
export default async function HowSearchEnginesCrawlUrls({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/url-slug-generator" className="text-blue-600 hover:underline">URL Slug Generator</Link> — Create crawl-friendly URL slugs</li>
              ...
              <li><Link href="/text-to-slug" className="text-blue-600 hover:underline">Text to Slug Converter</Link> — Convert text to crawlable URL slugs</li>
            </ul>
          </nav>
        </article>
      </main>

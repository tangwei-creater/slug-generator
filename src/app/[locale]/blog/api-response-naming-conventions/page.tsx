...
const slug = "api-response-naming-conventions";
...
export default async function ApiResponseNamingConventions({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/camelcase-converter" className="text-blue-600 hover:underline">CamelCase Converter</Link> — Convert text to camelCase for API keys</li>
              ...
              <li><Link href="/json-keys-to-camelcase" className="text-blue-600 hover:underline">JSON Keys to camelCase</Link> — Convert JSON response keys to camelCase</li>
            </ul>
          </nav>
        </article>
      </main>

...
const slug = "java-naming-conventions";
...
export default async function JavaNamingConventions({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/camelcase-converter" className="text-blue-600 hover:underline">CamelCase Converter</Link> — Convert text to camelCase (Java methods)</li>
              <li><Link href="/pascal-case-converter" className="text-blue-600 hover:underline">PascalCase Converter</Link> — Convert text to PascalCase (Java classes)</li>
              <li><Link href="/constant-case-converter" className="text-blue-600 hover:underline">CONSTANT_CASE Converter</Link> — Convert text to SCREAMING_SNAKE_CASE (Java constants)</li>
            </ul>
          </nav>
        </article>
      </main>

...
const slug = "redirect-301-vs-302";
...
export default async function Redirect301Vs302({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/url-slug-generator" className="text-blue-600 hover:underline">URL Slug Generator</Link> — Create redirect-friendly URL slugs</li>
              <li><Link href="/permalink-generator" className="text-blue-600 hover:underline">Permalink Generator</Link> — Generate permanent URLs that avoid redirects</li>
              <li><Link href="/slugify-online" className="text-blue-600 hover:underline">Slugify Online</Link> — Generate clean URL slugs</li>
            </ul>
          </nav>
        </article>
      </main>

...
const slug = "what-is-utf8-encoding";
...
export default async function WhatIsUtf8Encoding({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/slugify-online" className="text-blue-600 hover:underline">Slugify Online</Link> — Slugify UTF-8 text to URL-safe slugs</li>
              <li><Link href="/plain-text-converter" className="text-blue-600 hover:underline">Plain Text Converter</Link> — Normalize UTF-8 text encoding</li>
              <li><Link href="/text-to-slug" className="text-blue-600 hover:underline">Text to Slug Converter</Link> — Convert UTF-8 text to URL slugs</li>
            </ul>
          </nav>
        </article>
      </main>

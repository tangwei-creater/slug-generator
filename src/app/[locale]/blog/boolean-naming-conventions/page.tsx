...
const slug = "boolean-naming-conventions";
...
export default async function BooleanNamingConventions({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/camelcase-converter" className="text-blue-600 hover:underline">CamelCase Converter</Link> — Convert text to camelCase (boolean naming format)</li>

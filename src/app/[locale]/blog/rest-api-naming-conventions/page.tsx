...
const slug = "rest-api-naming-conventions";
...
export default async function RestApiNamingConventions({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/kebab-case-converter" className="text-blue-600 hover:underline">Kebab Case Converter</Link> — Convert text to kebab-case (REST endpoint convention)</li>
              <li><Link href="/snake-case-converter" className="text-blue-600 hover:underline">Snake Case Converter</Link> — Convert text to snake_case for API fields</li>
              <li><Link href="/camelcase-converter" className="text-blue-600 hover:underline">CamelCase Converter</Link> — Convert text to camelCase for JSON responses</li>
            </ul>
          </nav>
        </article>
      </main>

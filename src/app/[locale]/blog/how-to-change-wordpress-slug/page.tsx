...
const slug = "how-to-change-wordpress-slug";
...
export default async function HowToChangeWordpressSlug({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              ...
              <li><Link href="/slugify-online" className="text-blue-600 hover:underline">Slugify Online</Link> — Slugify text for WordPress URLs</li>
            </ul>
          </nav>
        </article>
      </main>

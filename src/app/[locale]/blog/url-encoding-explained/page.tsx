...
const slug = "url-encoding-explained";
...
export default async function UrlEncodingExplained({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/url-slug-generator" className="text-blue-600 hover:underline">URL Slug Generator</Link> — Create properly encoded URL slugs</li>
              <li><Link href="/slugify-online" className="text-blue-600 hover:underline">Slugify Online</Link> — Slugify text with proper encoding</li>
              <li><Link href="/text-to-slug" className="text-blue-600 hover:underline">Text to Slug Converter</Link> — Convert text to URL-safe encoded slugs</li>
            </ul>
          </nav>
        </article>
      </main>

...
const slug = "json-formatting-best-practices";
...
export default async function JsonFormattingBestPractices({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/json-keys-to-camelcase" className="text-blue-600 hover:underline">JSON Keys to camelCase</Link> — Convert JSON keys to camelCase format</li>
              <li><Link href="/json-keys-to-snake-case" className="text-blue-600 hover:underline">JSON Keys to snake_case</Link> — Convert JSON keys to snake_case format</li>

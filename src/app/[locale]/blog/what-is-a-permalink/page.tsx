...
const slug = "what-is-a-permalink";
...
export default async function WhatIsAPermalink({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              ...
              <li><Link href="/wordpress-slug-generator" className="text-blue-600 hover:underline">WordPress Slug Generator</Link> — Generate WordPress permalink slugs</li>
            </ul>
          </nav>
        </article>
      </main>

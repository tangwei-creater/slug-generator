...
const slug = "url-parameters-seo-guide";
...
export default async function UrlParametersSeoGuide({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/url-slug-generator" className="text-blue-600 hover:underline">URL Slug Generator</Link> — Create clean URLs without parameters</li>
              <li><Link href="/permalink-generator" className="text-blue-600 hover:underline">Permalink Generator</Link> — Generate parameter-free permanent URLs</li>

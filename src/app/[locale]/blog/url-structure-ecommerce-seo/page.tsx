...
const slug = "url-structure-ecommerce-seo";
...
export default async function UrlStructureEcommerceSeo({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/product-slug-generator" className="text-blue-600 hover:underline">Product Slug Generator</Link> — Generate e-commerce product URL slugs</li>
              ...
              <li><Link href="/permalink-generator" className="text-blue-600 hover:underline">Permalink Generator</Link> — Generate clean category and product URLs</li>
            </ul>
          </nav>
        </article>
      </main>

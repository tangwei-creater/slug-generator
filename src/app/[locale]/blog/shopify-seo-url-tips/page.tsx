...
const slug = "shopify-seo-url-tips";
...
export default async function ShopifySeoUrlTips({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              ...
              <li><Link href="/product-slug-generator" className="text-blue-600 hover:underline">Product Slug Generator</Link> — Generate slugs for product pages</li>

...
const slug = "medium-vs-self-hosted-blog-seo";
...
export default async function MediumVsSelfHostedBlogSeo({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              ...
              <li><Link href="/text-to-slug" className="text-blue-600 hover:underline">Text to Slug Converter</Link> — Convert blog titles to URL-safe slugs</li>
            </ul>
          </nav>
        </article>
      </main>

...
const slug = "hugo-url-slug-configuration";
...
export default async function HugoUrlSlugConfiguration({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              ...
              <li><Link href="/slugify-online" className="text-blue-600 hover:underline">Slugify Online</Link> — Slugify text for Hugo URLs</li>
              <li><Link href="/text-to-slug" className="text-blue-600 hover:underline">Text to Slug Converter</Link> — Convert titles to URL-safe slugs</li>
            </ul>
          </nav>
        </article>
      </main>

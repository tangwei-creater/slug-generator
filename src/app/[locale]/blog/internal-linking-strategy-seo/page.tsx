...
const slug = "internal-linking-strategy-seo";
...
export default async function InternalLinkingStrategySeo({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <nav className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <ul className="space-y-2 text-base">
              <li><Link href="/url-slug-generator" className="text-blue-600 hover:underline">URL Slug Generator</Link> — Create SEO-friendly URL slugs for internal links</li>
              <li><Link href="/permalink-generator" className="text-blue-600 hover:underline">Permalink Generator</Link> — Generate clean permanent URLs</li>
              <li><Link href="/text-to-slug" className="text-blue-600 hover:underline">Text to Slug Converter</Link> — Convert anchor text to URL-safe slugs</li>
            </ul>
          </nav>
        </article>
      </main>
